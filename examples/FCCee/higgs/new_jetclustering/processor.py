...
class jetclustering(processor.ProcessorABC):
    ...
    def process(self,events):
        ...
        Good_Z = ak.mask(Z,cuts.all())
        Good_Recoil = ak.mask(Recoil, cuts.all())
        ...
        pseudo_jets = ak.mask(pseudo_jets, ak.num(pseudo_jets, axis = 1) > 1) #Ensure that at least 2 particles are available
